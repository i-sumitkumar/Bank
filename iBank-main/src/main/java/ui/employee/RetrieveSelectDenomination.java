/*
 * Created by JFormDesigner on Thu Jul 04 00:20:15 EDT 2024
 */
 ...
 * @author amin_
 */
public class RetrieveSelectDenomination extends AbstractAdminPanel {
    ...
    public RetrieveSelectDenomination(AdminPanel adminPanel) {
        super(adminPanel);
        initComponents();
    }

    private void retrieveCash(ActionEvent e) {
        try {
            ATM atm = getAdminPanel().getAtm();
            atm.withdrawCash(denominationMap);
            getAdminPanel().getAtmService().logATMWithdraw(atm.getId(), getAdminPanel().getEmployee().getId(),
                    denominationMap);
    ...
    private void initComponents() {
        ...
        //---- button1 ----
        button1.setText("OK");
        button1.addActionListener(e -> retrieveCash(e));
